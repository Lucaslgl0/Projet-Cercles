...
class Cercles_complexe:
    ...
    def inversion_non_infinie(self, cercleinverseur):
        ...
        # attention le centre de self n'est pas envoyer sur le centre du nouveau cercle !!
        ...
        # le pointB est plus proche du centre du cercle inverseur
    ...
    def coordonnees_points_intersection(self, other):
        ...
        a = abs(
            (self.rayon**2 - (other.rayon**2) + distance**2) / (2 * distance)
            )
        b = abs(
        ...
        xcentre = self.centre[0] + (a / distance) * (
    ...
    def insertion(self, droite1, cercle_inverseur):
        ...
        nouveaucentre1 = (
            self.centre
            + 2 * self.rayon * Cercles_complexe.vecteur_normalise(droite1[1], droite1[0])
            )
        nouveaucentre2 = (
            self.centre
            - 2 * self.rayon * Cercles_complexe.vecteur_normalise(droite1[1], droite1[0])
        ...
        return [
            Cercles_complexe(nouveaucentre1, self.rayon, self.inversion_non_infinie(cercle_inverseur)),
            Cercles_complexe(nouveaucentre2, self.rayon, self.inversion_non_infinie(cercle_inverseur)),
            ]
    ...
    def calcul_new_cercle(self, cercle2: "Cercles_complexe", cercle3: "Cercles_complexe"):
        #######################################################################
            ...
            for cercle0 in C:
                for cercle in C:
                    if not cercle.egal(cercle0):
                        if cercle0.intersection(cercle):  # vérifie si cercle est tangent avec cercle0
                            cercle1 = cercle
                            continue
                for other in C:
                    ...
                    if other.intersection(cercle1) and other.intersection(cercle0):  # vérifie si other est tangent avec cercle0 et cercle1
                        ...
                        cercle_inverseur = Cercles_complexe(point_inverseur, rayon_inverseur)
